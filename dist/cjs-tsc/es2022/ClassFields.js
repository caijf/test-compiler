...
var B = /** @class */ (function () {
    ...
    B.prototype.m = function () {
        return tslib_1.__classPrivateFieldGet(this, _B_hidden, "f");
    };
    return B;
}());
...
var C = /** @class */ (function () {
    ...
    C.prototype.m = function () {
        return this.a + this.b + tslib_1.__classPrivateFieldGet(this, _C_d, "f");
    };
    C.prototype.n = function () {
        return this.a + this.b + tslib_1.__classPrivateFieldGet(this, _C_d, "f");
    };
    C.prototype.t = function () {
        return tslib_1.__classPrivateFieldGet(this, _C_instances, "m", _C_s).call(this);
    };
    return C;
}());
...
var ColorFinder = /** @class */ (function () {
    ...
    ColorFinder.colorName = function (name) {
        switch (name) {
            case "red": return tslib_1.__classPrivateFieldGet(ColorFinder, _a, "f", _ColorFinder_red);
            case "blue": return tslib_1.__classPrivateFieldGet(ColorFinder, _a, "f", _ColorFinder_blue);
            case "green": return tslib_1.__classPrivateFieldGet(ColorFinder, _a, "f", _ColorFinder_green);
