...
try {
    for (var _c = tslib_1.__values(Object.entries(obj3)), _d = _c.next(); !_d.done; _d = _c.next()) {
...
try {
    for (var _f = tslib_1.__values(Object.entries(obj5)), _g = _f.next(); !_g.done; _g = _f.next()) {
